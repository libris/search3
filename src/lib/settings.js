export default {
	...
	environment: import.meta.env.VITE_VUE_APP_ENV_LABEL || 'local',
	dataPath: import.meta.env.VITE_VUE_APP_API_PATH,
	// apiPath: runtimeConfig.API_PATH || import.meta.env.VITE_VUE_APP_API_PATH || 'http://kblocalhost.kb.se:5000',
	// apiPath: runtimeConfig.API_PATH || import.meta.env.VITE_VUE_APP_API_PATH || 'https://libris-qa.kb.se',
	apiPath: runtimeConfig.API_PATH || import.meta.env.VITE_VUE_APP_API_PATH || 'https://libris-dev2.kb.se',
	verifyPath: import.meta.env.VITE_VUE_APP_VERIFY_PATH,
	// idPath: runtimeConfig.ID_PATH || import.meta.env.VITE_VUE_APP_ID_PATH || 'http://id.kblocalhost.kb.se:5000',
	// idPath: runtimeConfig.ID_PATH || import.meta.env.VITE_VUE_APP_ID_PATH || 'https://id-qa.kb.se',
	idPath: runtimeConfig.ID_PATH || import.meta.env.VITE_VUE_APP_ID_PATH || 'https://id-dev2.kb.se',
	authPath: import.meta.env.VITE_VUE_APP_AUTHORIZE_PATH,
	redirectPath: import.meta.env.VITE_VUE_APP_REDIRECT_PATH,
	clientId: import.meta.env.VITE_VUE_APP_CLIENT_ID || '51aec4d330bf9cb9af603af778850886',
	siteAlias: import.meta.env.VITE_VUE_APP_SITE_ALIAS,
	mockDisplay: import.meta.env.VITE_VUE_APP_MOCK_DISPLAY_BOOL === 'true',
	mockHelp: import.meta.env.VITE_VUE_APP_MOCK_HELP_BOOL === 'true',
	scopes: 'read write',
	matomoId: 23,
	appPaths: {
	  '/find?': '/search/libris?',
