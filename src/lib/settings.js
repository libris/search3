export default {
	...
	gitDescribe: JSON.parse(import.meta.env.VUE_APP_GIT_DESCRIBE || null),
	environment: import.meta.env.VUE_APP_ENV_LABEL || 'local',
	...
	siteAlias: import.meta.env.VUE_APP_SITE_ALIAS,
	mockDisplay: import.meta.env.VUE_APP_MOCK_DISPLAY_BOOL === 'true',
	mockHelp: import.meta.env.VUE_APP_MOCK_HELP_BOOL === 'true',
	scopes: 'read write',
	matomoId: 23,
	appPaths: {
	  '/find?': '/search/libris?',
